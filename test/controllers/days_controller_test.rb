...
class DaysControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create day" do
    assert_difference('Day.count') do
      post days_url, params: { day: { description: @day.description, title: @day.title, trip_id: @day.trip_id } }
    end
  ...
  test "should update day" do
    patch day_url(@day), params: { day: { description: @day.description, title: @day.title, trip_id: @day.trip_id } }
